          ...
          <div class="relative bg-gray-700 border-black border-2 rounded-lg shadow-lg dark:bg-gray-700">
            ...
            <div class="p-4 md:p-5">
              <form class="space-y-4" action="#" onSubmit={handleSubmit}>
                ...
                <div class="flex justify-center">{selectedImage ? <img className="w-full h-auto mt-[-10px]" src={selectedImage} alt="Selected Image" style={{ maxWidth: "500px", height: "300px", objectFit: "contain" }} /> : null}</div>
                <input
