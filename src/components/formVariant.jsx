          ...
          <div class="relative mt-6 w-full max-w-lg max-h-full">
            ...
            <div class="relative bg-gray-700 border-black border-2 rounded-lg shadow-lg dark:bg-gray-700">
              ...
              <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                <h3 class="text-xl font-semibold text-white dark:text-white">{item?.item?.product_type?.type_name}, {item?.item?.product_size?.size_name}</h3>
                <button
                  type="button"
                  onClick={() => {
                    setShowModal(false);
        ...
        <div class="w-full max-w-md p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
          <div class="flex items-center justify-between mb-4">
            ...
            <button
                  ...
                  onClick={()=>{setShowModal(true); setVariant(item?.item)}}
                >
